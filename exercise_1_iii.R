...
# The 95% confidence interval is: amount_bar +/- 1.96 sqrt(Var_k/k)

Upper = amount_bar + 1.96*sqrt(Var_k/k)
Lower = amount_bar - 1.96*sqrt(Var_k/k)

print(paste("We are 95% confident that T is in the interval [",round(Lower, digits=4),",",round(Upper, digits=4),"]"))
