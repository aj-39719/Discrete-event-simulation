...
# Hence, we see that the max frequency for our claim amount is 6391 
# which can be used to scale up our density curve, we use 6400 as an approximate guess

lines((300*x)+500, exp(-x)*6400, lwd = 3, col = "darkorange")


print(paste("The average number of iterations run = ",mean(counter_tuple)))
print(paste("The expected number of iterations expected(c) = ", c))
